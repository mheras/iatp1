...
public abstract class AProblem {
	...
	private IReproductionAlgorithm reproduction;
	/* The aptitude function to evaluate an individual. */
	private IAptitude aptitude;

	public AProblem(IPopulationAlgorithm selection,
	...
	public IReproductionAlgorithm getReproduction() {
		return reproduction;
	}

	public void setReproduction(IReproductionAlgorithm reproduction) {
		this.reproduction = reproduction;
	}
