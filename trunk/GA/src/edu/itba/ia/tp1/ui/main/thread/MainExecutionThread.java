...
import edu.itba.ia.tp1.ui.main.MainAptitudeChart;
...
public class MainExecutionThread extends SwingWorker<Void, Void> {
	...
	/* Done callback. */
	private IMainExecutionThreadDone doneCallback;
	/* Engine info callback. */
	private IMainEngineInfo engineInfoCallback;
	/* Population size. */
	 ...
	 */
	public MainExecutionThread(IMainExecutionThreadDone doneCallback,
			IMainEngineInfo engineInfoCallback) {
		this();
	...
	protected Void doInBackground() throws Exception {
		...
		MainAptitudeChart chart = MainAptitudeChart.getInstance();
