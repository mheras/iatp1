 ...
 * 
 */
public class AlternativeAptitudeBit4Chart extends
		AbstractAlternativeAptitudeChart {

	/* Singleton instance. */
	private static AlternativeAptitudeBit4Chart instance;
	 ...
	 */
	public static AlternativeAptitudeBit4Chart getInstance() {
		if (instance == null) {
			instance = new AlternativeAptitudeBit4Chart();
		}
		return instance;
	}
	 ...
	 */
	private AlternativeAptitudeBit4Chart() {
		...
		JFreeChart chart = new JFreeChart("Bit 4", this.plot);
