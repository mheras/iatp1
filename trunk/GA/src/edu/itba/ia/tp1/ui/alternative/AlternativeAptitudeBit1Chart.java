 ...
 * 
 */
public class AlternativeAptitudeBit1Chart extends
		AbstractAlternativeAptitudeChart {

	/* Singleton instance. */
	private static AlternativeAptitudeBit1Chart instance;
	 ...
	 */
	public static AlternativeAptitudeBit1Chart getInstance() {
		if (instance == null) {
			instance = new AlternativeAptitudeBit1Chart();
		}
		return instance;
	}
	 ...
	 */
	private AlternativeAptitudeBit1Chart() {
		...
		JFreeChart chart = new JFreeChart("Bit 1", this.plot);
