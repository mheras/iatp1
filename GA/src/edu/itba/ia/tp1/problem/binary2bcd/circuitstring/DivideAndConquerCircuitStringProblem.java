 ...
 * 
 */
public class DivideAndConquerCircuitStringProblem extends A_Problem {
	 ...
	 *            Population size.
	 */
	public DivideAndConquerCircuitStringProblem(I_SelectionAlgorithm selection,
	...
	protected Population initPopulation(Long populationSize) {
		...
		for (long i = 0; i < populationSize; i++) {
			...
			A_Individual circuit = CircuitString.generateRandomCircuit(4, 1,
					10, 40);
