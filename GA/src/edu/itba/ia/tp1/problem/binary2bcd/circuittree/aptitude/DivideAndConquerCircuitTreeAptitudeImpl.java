 ...
 */
public class DivideAndConquerCircuitTreeAptitudeImpl extends AbstractAptitude {

	/**
	 * Creates a new instance of <code>AptitudeImpl</code>.
	 */
	public DivideAndConquerCircuitTreeAptitudeImpl(int bit) {
	...
	/**
	 * Old approach to get individual aptitude.
	 * 
	 * @deprecated
	 * @param individual
	 *            The individual.
