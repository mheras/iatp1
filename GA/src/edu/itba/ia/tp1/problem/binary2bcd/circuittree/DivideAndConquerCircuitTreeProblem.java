 ...
 */
public class DivideAndConquerCircuitTreeProblem extends AbstractProblem {
	 ...
	 */
	public DivideAndConquerCircuitTreeProblem(ISelectionAlgorithm selection,
	...
	public Population initPopulation(Long populationSize) {
		...
		for (long i = 0; i < populationSize; i++) {
			...
			AbstractIndividual circuit =	CircuitTree.generateRandomCircuit(4, 1, 10, 40);
