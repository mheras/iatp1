 ...
 * 
 */
public class AlternativeAptitudeBit2Chart extends
		AbstractAlternativeAptitudeChart {

	/* Singleton instance. */
	private static AlternativeAptitudeBit2Chart instance;
	 ...
	 */
	public static AlternativeAptitudeBit2Chart getInstance() {
		if (instance == null) {
			instance = new AlternativeAptitudeBit2Chart();
		}
		return instance;
	}
	 ...
	 */
	private AlternativeAptitudeBit2Chart() {
		...
		JFreeChart chart = new JFreeChart("Bit 2", this.plot);
